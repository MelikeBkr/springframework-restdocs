= Spring Framework Coffee Order Service Docs
Melike Bakir;
:doctype: book
:icons: font
:source-highlighter: highlightjs

Sample application demonstrating how to use Spring REST Docs with JUnit 4.

`CoffeeOrderControllerTest` makes a call to a very simple service and produces three
